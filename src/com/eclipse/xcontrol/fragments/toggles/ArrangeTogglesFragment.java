...
public class ArrangeTogglesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)
                inflater.inflate(R.layout.arrange_toggles, container, false);
    ...
    static ArrayList<String> getEnabledToggles(Context context) {
        try {
            ...
            String userToggles = Settings.ECLIPSE.getString(context.getContentResolver(),
                    Settings.ECLIPSE.QUICK_TOGGLES);
    ...
    static void setTogglesFromStringArray(Context c, List<String> enabledToggles) {
        ...
        Settings.ECLIPSE.putString(c.getContentResolver(), Settings.ECLIPSE.QUICK_TOGGLES,
                b.toString());
    }
