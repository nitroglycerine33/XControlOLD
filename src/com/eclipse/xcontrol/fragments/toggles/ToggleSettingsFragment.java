package com.eclipse.xcontrol.fragments.toggles;
...
import com.eclipse.xcontrol.settings.BaseSetting;
import com.eclipse.xcontrol.settings.BaseSetting.OnSettingChangedListener;
import com.eclipse.xcontrol.settings.SingleChoiceSetting;
...
public class ToggleSettingsFragment extends Fragment implements OnSettingChangedListener, OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.toggle_setup, container, false);
    ...
    public void onSettingChanged(String table, String key, String oldValue, String value) {
        if (table.equals("eclipse") && key.equals(mToggleStyle.getKey())) {
                ...
                if (cursor != null) {
                    try {
                        if (cursor.moveToFirst()) {
                            ...
                            Settings.ECLIPSE.putString(getActivity().getContentResolver(),
                                    Settings.ECLIPSE.QUICK_TOGGLE_FAV_CONTACT, lookup_key);
                        }
                    } finally {
                        cursor.close();
                    }
